...
화면 중앙의 게임시작 버튼을 눌러서 게임을 시작하세요. 우측 상단의 언어 버튼을 이용해서 영어와 한국어 중 선택할수 있습니다. 선택한 언어와 최고점수는 브라우저에 로컬로 저장됩니다.

## 규칙

- 터치&드래그로 사각형 영역을 선택할 수 있습니다.
- 선택한 숫자의 합이 10이 되면, 유미나가 간식을 획득합니다.
- 간식을 획득할 때마다 1점이 추가됩니다.
- 제한 시간 안에 최대한 많은 간식을 획득하여 높은 점수에 도전하세요.
- 제한 시간이 끝나기 전에 모든 간식을 획득하면 남은 시간이 기록됩니다.
